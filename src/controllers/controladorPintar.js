export function pintarProductos(productos){
    ...
    productos.forEach(function(producto){
        ...
        precio.classList.add("fw-bold","textositios")
        ...
        // 2.6 Creamos la popularidad
        let estrella=document.createElement("i")
        estrella.classList.add("bi","bi-star-fill","d-none")
        estrella.textContent=producto.popularidad
        ...
        //     popularidad.classList.add("bi", "bi-star-fill""bi", "bi-star-fill")
